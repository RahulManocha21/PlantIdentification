...
if submit:
    if input_question and image:
        ...
        Write your answer in layman's terms with less technicalities, so everyone can understand. If user asking you for website to buy the pesticides for cure or plants in the image, then you should 
        refer the product from Brecks website, Gurneys website, springhillnursery website only."
